...
import br.com.springboot.app.AplicacaoRestApplication;
...
public class ToDoControllerTest {
	...
	public void shouldVerifyToDoList() throws Exception {
		...
		// contem 5 elementos por causa do teste de inserte logo abaixo nos testes.
		.andExpect(jsonPath("$", hasSize(5))).andDo(print());
	}
	
	
	@Test
	public void shouldVerifyToDoById() throws Exception {
	...
	@Test
	public void shouldVerifyInvalidToDoArgument() throws Exception {
	...
	@Test
	public void shouldVerifyInvalidToDoId() throws Exception {
	...
	@Test
	public void shouldVerifyNullToDo() throws Exception {
	...
	@Test
	public void shouldVerifyDeleteToDo() throws Exception {
	...
	@Test
	public void shouldVerifyInvalidToDoIdToDelete() throws Exception {
	...
	@Test
	public void shouldVerifySaveToDo() throws Exception {
	...
	@Test
	public void shouldVerifyMalFormedSaveToDo() throws Exception {
		mockMvc.perform(MockMvcRequestBuilders.post("/todo/")
				       .contentType(MediaType.APPLICATION_JSON)
				       .content("{\"id\": \"8\" , \"text\" : \"New ToDo Sample 8\" , \"completed\" : \"false\"  }")
				       .accept(MediaType.APPLICATION_JSON))
		       .andExpect(jsonPath("$.errorCode").value(404))
	...
	@Test
	public void shouldVerifyUpdateToDo() throws Exception {
	...
	@Test
	public void shouldVerifyInvalidToDoUpdate() throws Exception {
		mockMvc.perform(MockMvcRequestBuilders.put("/todo/")
        .contentType(MediaType.APPLICATION_JSON)
